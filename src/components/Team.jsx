                ...
                <div className="container" data-aos="fade-up" data-aos-delay="100">
                    ...
                    <div className="row gy-4">
                        ...
                        <div className="col-xl-3 col-lg-4 col-md-6" data-aos="fade-up" data-aos-delay="200">
                            <div className="instructor-card">
                                <div className="instructor-image">
                                    <img src="assets/img/education/teacher-2.webp" className="img-fluid" alt=""/>
                                ...
                                <div className="instructor-info">
                                    ...
                                    <p className="description">Nulla facilisi morbi tempus iaculis urna id volutpat
                        ...
                        <div className="col-xl-3 col-lg-4 col-md-6" data-aos="fade-up" data-aos-delay="250">
                            <div className="instructor-card">
                                <div className="instructor-image">
                                    <img src="assets/img/education/teacher-7.webp" className="img-fluid" alt=""/>
                                    <div className="overlay-content">
                                        <div className="rating-stars">
                                            <i className="bi bi-star-fill"></i>
                                            <i className="bi bi-star-fill"></i>
                                ...
                                <div className="instructor-info">
                                    ...
                                    <p className="description">Suspendisse potenti nullam ac tortor vitae purus faucibus
                                        ornare suspendisse sed nisi.</p>
                                    <div className="stats-grid">
                                        <div className="stat">
                        ...
                        <div className="col-xl-3 col-lg-4 col-md-6" data-aos="fade-up" data-aos-delay="300">
                            <div className="instructor-card">
                                <div className="instructor-image">
                                    <img src="assets/img/education/teacher-4.webp" className="img-fluid" alt=""/>
                                    <div className="overlay-content">
                                        <div className="rating-stars">
                                            <i className="bi bi-star-fill"></i>
                                            <i className="bi bi-star-fill"></i>
                                ...
                                <div className="instructor-info">
                                    ...
                                    <p className="description">Pellentesque habitant morbi tristique senectus et netus
                                        et malesuada fames ac turpis.</p>
                                    <div className="stats-grid">
                                        <div className="stat">
                        ...
                        <div className="col-xl-3 col-lg-4 col-md-6" data-aos="fade-up" data-aos-delay="350">
                            <div className="instructor-card">
                                <div className="instructor-image">
                                    <img src="assets/img/education/teacher-9.webp" className="img-fluid" alt=""/>
                                    <div className="overlay-content">
                                        <div className="rating-stars">
                                            <i className="bi bi-star-fill"></i>
                                            <i className="bi bi-star-fill"></i>
                                ...
                                <div className="instructor-info">
                                    ...
                                    <p className="description">Vivamus magna justo lacinia eget consectetur sed
                                        convallis at tellus curabitur non nulla.</p>
                                    <div className="stats-grid">
                                        <div className="stat">
